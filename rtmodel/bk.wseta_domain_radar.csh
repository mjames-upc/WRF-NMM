...
while ($#FLOATERS >= 3 )
   ...
   /usr/bin/python ${TOP}/scripts/lcc2xy.py $LAT $LON $DATE >>! /tmp/.xy.$$
   set OLAT = $LAT
   set OLON = $LON
end

#set COLORS=("26" "23" "5" "17" "2")
#set POSN=(".82;.98" ".625;.98" ".43;.98" ".235;.98" ".04;.98")
#set POST=(".845;.98" ".65;.98" ".455;.98" ".26;.98" ".065;.98")
#set MAPL=("730,560,840,580" "550,560,670,580" "380,560,490,580" "200,560,320,580" "30,560,140,580")
...
# var colors = ["#ff0000","#f87800","#e8e800","#00c800","#1890f8"];
# var runs = ["2013121718","2013121618","2013121706","2013121712","2013121700"];
# var xpos = ["0.693788485992","0.94850177971","0.955535133819","0.831439602573","0.931753268209"];
# var ypos = ["0.830292331934","0.906589349051","0.693469185883","0.631968324789","0.644509752722"];
